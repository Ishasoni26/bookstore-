  ...
  return (
   ...
   <div className='max-w-screen-2x1 container mx-auto md:px-20 px-4 flex flex-col md:flex-row my-10'>
    <div className="order-2 md:order-1 w-full md:w-1/2 mt-12 md:mt-32 ">
      ...
      <p className='text-xl font-semibold'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Enim ipsa minima voluptas non et eaque cum? Placeat, numquam iste culpa adipisci eveniet quidem laboriosam, voluptatem aut mollitia ea ipsum distinctio.</p>
